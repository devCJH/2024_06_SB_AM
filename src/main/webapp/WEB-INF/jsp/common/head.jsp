	...
	<div class="h-20 flex container mx-auto text-3xl">
		...
		<div class="grow flex items-center justify-end mr-5">
			<label class="swap swap-rotate">
			  <input type="checkbox" id="themeChk" onchange="Theme_swap();"/>
		...
		<script>
			const checkbox = $('#themeChk');
			
			function Theme_swap() {
				localStorage.setItem("chkState", checkbox.prop('checked'));
				...
				Theme_apply(localStorage.getItem("theme"));
			}
			
			function Theme_apply(themeName) {
				$('html').attr('data-theme', themeName);
			}
			
			function Theme_init() {
				const isChecked = localStorage.getItem("chkState") === "true";
